...
A simple shell is a command-line interpreter (CLI) program that takes commands from the user and executes them. It is a relatively simple program that does not have many features, such as the ability to redirect input and output, or to create and manage processes.
...
First, remember the [framework](https://intranet.alxswe.com/concepts/559). If you do not know it by heart already, it is probably a good idea to read it again. 
...
* **Everything you need to know to start coding your own shell** [concept page](https://intranet.alxswe.com/concepts)
